...
- Broader Pro deterministic validation on `~/Downloads/docs` is `173/197` strict pass in `out/full-pro-deterministic-20260508-rerun.json`; remaining errors are mostly strict range clipping, container-child policy, disputed labels, no-clasificado false positives, and cedula front/back edges.
